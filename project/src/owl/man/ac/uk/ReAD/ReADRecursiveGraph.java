...
public class ReADRecursiveGraph extends RecursiveTask<IdentityMultiMap<OWLClass, OWLClass>>{
	...
	public ReADRecursiveGraph(Map<Set<OWLClass>, Set<OWLAxiom>> bigDepen, List<Set<OWLClass>> sigs, 
