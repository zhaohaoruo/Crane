...
public class Reasoner implements OWLReasoner {
    ...
    public Reasoner(OWLOntology rootOntology) {
        this(new Configuration(),rootOntology,(Set<DescriptionGraph>)null, null);
    }
     ...
     *            - the ontology that should be loaded by the reasoner
     */
    public Reasoner(Configuration configuration,OWLOntology rootOntology, ReADSetting reAD) {
        this(configuration,rootOntology,(Set<DescriptionGraph>)null, reAD);
    }
     ...
     */
    public Reasoner(Configuration configuration,OWLOntology rootOntology,Collection<DescriptionGraph> descriptionGraphs, ReADSetting reAD) {
    ...
    protected Hierarchy<AtomicConcept> classifyAtomicConcepts(Tableau tableau,ClassificationProgressMonitor progressMonitor,AtomicConcept topElement,AtomicConcept bottomElement,Set<AtomicConcept> elements,boolean forceQuasiOrder) {
        if (tableau.isDeterministic() && !forceQuasiOrder)
            return new DeterministicClassification(tableau,progressMonitor,topElement,bottomElement,elements, m_reAD).classify();
        else
            return new QuasiOrderClassification(tableau,progressMonitor,topElement,bottomElement,elements, m_reAD).classify();
    }
    ...
    public static class ReasonerFactory implements OWLReasonerFactory {
        ...
        protected OWLReasoner createHermiTOWLReasoner(Configuration configuration,OWLOntology ontology) {
            return new Reasoner(configuration,ontology, null);
        }
    }
}
